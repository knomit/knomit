...
// latency synthesis actually experiences. Buckets run to ten minutes because
// long-context synthesis completions legitimately take minutes.
var llmRequestSeconds = metrics.Default().Histogram(
	...
	[]float64{0.5, 1, 2.5, 5, 10, 30, 60, 120, 300, 600},
)
