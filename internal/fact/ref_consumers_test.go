...
func TestRefClassification_HasNoSecondImplementation(t *testing.T) {
	...
	allowed := map[string]string{
		...
		filepath.Join("internal", "okfsource", "history.go"):         "selects fact files out of a git tree",
		filepath.Join("internal", "okfsource", "facts.go"):           "selects fact files out of a git tree",
