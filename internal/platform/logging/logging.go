...
//
// RFC3339 specifically, and not a "Jan 2 15:04:05" style: the Manage Logs tab
// reads a console-formatted line as `<stamp> <LVL> <message>`
// (web/src/LogView.tsx parseLine), so a timestamp containing a space would
// shift the level out of the second position and silently break the tab's
// level filter. RFC3339 has no spaces. TestFileSinkTimestampIsDatedAndSpaceFree
// pins that.
//
