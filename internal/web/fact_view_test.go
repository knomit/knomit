...
func TestFactView_Origin_SerializesNonDefaultAndElidesAuthored(t *testing.T) {
	...
	view := BuildFactView(b, "alpha", a, "7f3a8b2c", f, resolver, testLocalRepoID, nil)
...
func TestFactView_HEAD_RequiredLinks(t *testing.T) {
	...
	view := BuildFactView(b, "alpha", a, headCommit, makeTestFact(), resolver, testLocalRepoID, nil)
	raw, err := json.Marshal(view)
	if err != nil {
...
func TestFactView_CommitAnchored_HasIncomingLiveNoSnapshot(t *testing.T) {
	...
	view := BuildFactView(b, "alpha", a, "", makeTestFact(), resolver, testLocalRepoID, nil)
	raw, err := json.Marshal(view)
	if err != nil {
		t.Fatalf("marshal: %v", err)
	}
...
func TestFactView_AsOf_HEADUsesHeadCommit(t *testing.T) {
	...
	view := BuildFactView(b, "alpha", a, "7f3a8b2c", makeTestFact(), resolver, testLocalRepoID, nil)
...
func TestFactView_Kind_PragmaticSerializes(t *testing.T) {
	...
	view := BuildFactView(b, "alpha", a, "deadbeef", f, resolver, testLocalRepoID, nil)
