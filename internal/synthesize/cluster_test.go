...
func TestScopedCluster_EmptySeeds(t *testing.T) {
	...
	result, err := ScopedCluster(context.Background(), nil, idx, 1.0, nil, "agent/test")
	if err != nil {
...
func TestScopedCluster_SeedsAndNeighborsClustered(t *testing.T) {
	...
	result, err := ScopedCluster(context.Background(), []factForLLM{seed}, idx, 1.0, nil, "agent/test")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestScopedCluster_CategoryFallbackOnLouvainError(t *testing.T) {
	...
	idx.EXPECT().Search(gomock.Any(), gomock.Any(), gomock.Any()).Return([]store.SearchResult{
	...
	result, err := ScopedCluster(context.Background(), []factForLLM{seed1, seed2}, idx, 1.0, nil, "agent/test")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestScopedCluster_ExcludeTypesPassedToSearch(t *testing.T) {
	...
	result, err := ScopedCluster(context.Background(), []factForLLM{seed}, idx, 1.0, nil, "agent/test", "hypothesis")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if len(result) != 1 {
...
func TestScopedCluster_NoExcludeTypesByDefault(t *testing.T) {
	...
	_, _ = ScopedCluster(context.Background(), []factForLLM{seed}, idx, 1.0, nil, "agent/test")
}
