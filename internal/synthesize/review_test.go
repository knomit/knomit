...
func TestStartSession_NoDirtyFacts(t *testing.T) {
	...
	ri.EXPECT().GetPipelineWatermark(gomock.Any(), "review", "machine/test").Return("", nil)
	idx.EXPECT().Search(gomock.Any(), gomock.Any(), store.SearchQuery{Limit: 100_000}).Return(nil, nil)

	// Complete session immediately.
	ri.EXPECT().CompletePipelineSession(gomock.Any(), "sess-1").Return(nil)
	gs.EXPECT().HeadCommit(gomock.Any(), "machine/test").Return("abc123", nil)
	ri.EXPECT().SetPipelineWatermark(gomock.Any(), "review", "machine/test", "abc123").Return(nil)
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-1").Return(0, 0, nil)
...
func TestStartSession_WatermarkAtHead_NoDirtyFacts(t *testing.T) {
	...
	ri.EXPECT().GetPipelineWatermark(gomock.Any(), "review", "machine/test").Return("head-hash", nil)

	// DiffFiles returns no changes since watermark == HEAD.
	gs.EXPECT().DiffFiles(gomock.Any(), "machine/test", "head-hash").Return(nil, nil, nil, nil)

	// No dirty facts → session completes immediately.
	ri.EXPECT().CompletePipelineSession(gomock.Any(), "sess-wm").Return(nil)
	gs.EXPECT().HeadCommit(gomock.Any(), "machine/test").Return("head-hash", nil)
	ri.EXPECT().SetPipelineWatermark(gomock.Any(), "review", "machine/test", "head-hash").Return(nil)
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-wm").Return(0, 0, nil)
...
func TestStartSession_WatermarkEmpty_AllFactsDirty(t *testing.T) {
	...
	idx.EXPECT().ClusterFacts(gomock.Any(), gomock.Any(), 1.0, 2).Return(store.ClusterResult{}, fmt.Errorf("no embeddings"))
	...
	// nextItem call.
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-2").Return(&store.PipelineWorkItem{
		ID:        1,
		SessionID: "sess-2",
		StepType:  "prune",
	...
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-2").Return(0, 2, nil)
...
func TestStartSession_WithWatermark(t *testing.T) {
	...
	gs.EXPECT().DiffFiles(gomock.Any(), "machine/test", "old-hash").Return(nil, []string{"kb/go/one.md"}, nil, nil)
	...
	idx.EXPECT().Search(gomock.Any(), gomock.Any(), gomock.Any()).DoAndReturn(func(ctx context.Context, branch string, q store.SearchQuery) ([]store.SearchResult, error) {
	...
	idx.EXPECT().ClusterFacts(gomock.Any(), gomock.Any(), 1.0, 2).Return(store.ClusterResult{
	...
	// nextItem call.
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-3").Return(&store.PipelineWorkItem{
		ID:        1,
		SessionID: "sess-3",
		StepType:  "prune",
		FactsJSON: mustJSON(t, []factForLLM{
	...
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-3").Return(0, 1, nil)
...
func TestContinueSession_PruneResponse(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-1").Return(&store.PipelineSession{
		ID: "sess-1", Branch: "machine/test", Status: "active",
	}, nil)
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-1").Return(&store.PipelineWorkItem{
		ID:        1,
		SessionID: "sess-1",
		StepType:  "prune",
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-1").Return(nil, nil)
	...
	ri.EXPECT().CompletePipelineSession(gomock.Any(), "sess-1").Return(nil)
	gs.EXPECT().HeadCommit(gomock.Any(), "machine/test").Return("new-hash", nil)
	ri.EXPECT().SetPipelineWatermark(gomock.Any(), "review", "machine/test", "new-hash").Return(nil)
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-1").Return(1, 0, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	result, err := r.ContinueSession(context.Background(), "sess-1", pruneResp)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if !result.Done {
...
func TestContinueSession_ReturnsNextItem(t *testing.T) {
	...
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-1").Return(1, 1, nil)
...
func TestContinueSession_InvalidSession(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "bad-id").Return(nil, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	_, err := r.ContinueSession(context.Background(), "bad-id", "{}")
	if err == nil {
...
func TestContinueSession_CompletedSession(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "done-sess").Return(&store.PipelineSession{
		ID: "done-sess", Branch: "machine/test", Status: "completed",
	}, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	_, err := r.ContinueSession(context.Background(), "done-sess", "{}")
	if err == nil {
...
func TestContinueSession_InvalidJSON(t *testing.T) {
	...
	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	_, err := r.ContinueSession(context.Background(), "sess-1", "not valid json at all")
	if err == nil {
...
func TestContinueSession_DistillResponse(t *testing.T) {
	...
	ri.EXPECT().SetPipelineWorkItemResponse(gomock.Any(), int64(2), distillResp).Return(nil)
	...
	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	result, err := r.ContinueSession(context.Background(), "sess-1", distillResp)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if !result.Done {
...
func TestContinueSession_ValidationError(t *testing.T) {
	...
	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	_, err := r.ContinueSession(context.Background(), "sess-1", badResp)
	if err == nil {
...
func TestDirtyFacts_Incremental_OnlyChangedFiles(t *testing.T) {
	...
	ri.EXPECT().GetPipelineWatermark(gomock.Any(), "review", "machine/test").Return("abc123", nil)
	gs.EXPECT().DiffFiles(gomock.Any(), "machine/test", "abc123").Return(
...
func TestContinueSession_RAPTOR_EnqueuesDeeper(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-r").Return(&store.PipelineSession{
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-r").Return(&store.PipelineWorkItem{
		ID:        1,
		SessionID: "sess-r",
		StepType:  "distill",
	...
	ri.EXPECT().SetPipelineWorkItemResponse(gomock.Any(), int64(1), distillResp).Return(nil)
	...
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-r").Return(1, 1, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	result, err := r.ContinueSession(context.Background(), "sess-r", distillResp)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestContinueSession_RAPTOR_StopsAtMaxDepth(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-max").Return(&store.PipelineSession{
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-max").Return(&store.PipelineWorkItem{
		ID:        5,
		SessionID: "sess-max",
		StepType:  "distill",
		FactsJSON: mustJSON(t, inputFacts),
	...
	ri.EXPECT().SetPipelineWorkItemResponse(gomock.Any(), int64(5), distillResp).Return(nil)

	// nextItem: done — reflect check finds no transitions.
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-max").Return(nil, nil)
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-max").Return(&store.PipelineSession{
		ID: "sess-max", Branch: "machine/test", Status: "active",
	}, nil)
	ri.EXPECT().GetPipelineWatermark(gomock.Any(), "review", "machine/test").Return("", nil)
	...
	ri.EXPECT().CompletePipelineSession(gomock.Any(), "sess-max").Return(nil)
	gs.EXPECT().HeadCommit(gomock.Any(), "machine/test").Return("final-hash", nil)
	ri.EXPECT().SetPipelineWatermark(gomock.Any(), "review", "machine/test", "final-hash").Return(nil)
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-max").Return(1, 0, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	result, err := r.ContinueSession(context.Background(), "sess-max", distillResp)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if !result.Done {
...
func TestRunAll_ProcessesAllWorkItems(t *testing.T) {
	...
	idx.EXPECT().Search(gomock.Any(), gomock.Any(), gomock.Any()).Return(nil, nil).AnyTimes()
	idx.EXPECT().ClusterFacts(gomock.Any(), gomock.Any(), 1.0, 2).Return(store.ClusterResult{}, fmt.Errorf("no embeddings")).AnyTimes()

	// Insert prune + distill work items (2 seeds, 1 cluster of 2).
	ri.EXPECT().InsertPipelineWorkItem(gomock.Any(), gomock.Any()).Return(nil).Times(2)
	...
	nextWorkItemCall := ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-run")
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-run").Return(&store.PipelineSession{
		ID: "sess-run", Branch: "machine/test", Status: "active",
	}, nil).AnyTimes()
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-run").Return(pruneItem, nil)  // ContinueSession: current item
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-run").Return(0, 2, nil)       // StartSession stats

	pruneResp := `{"decisions": [{"path": "kb/go/one.md", "action": "keep"}, {"path": "kb/go/two.md", "action": "keep"}]}`
	ri.EXPECT().SetPipelineWorkItemResponse(gomock.Any(), int64(1), pruneResp).Return(nil)
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-run").Return(distillItem, nil) // after prune: next is distill
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-run").Return(1, 1, nil)
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-run").Return(distillItem, nil) // current distill item

	distillResp := `{"synthesize": [], "retract": []}`
	ri.EXPECT().SetPipelineWorkItemResponse(gomock.Any(), int64(2), distillResp).Return(nil)

	// After distill: no more items → reflect check (no watermark → no transitions) → complete session.
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-run").Return(nil, nil)
	ri.EXPECT().GetPipelineWatermark(gomock.Any(), "review", "machine/test").Return("", nil)
	ri.EXPECT().CompletePipelineSession(gomock.Any(), "sess-run").Return(nil)
	gs.EXPECT().HeadCommit(gomock.Any(), "machine/test").Return("final-hash", nil)
	ri.EXPECT().SetPipelineWatermark(gomock.Any(), "review", "machine/test", "final-hash").Return(nil)
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-run").Return(2, 0, nil)
...
func TestRunAll_NoDirtyFacts(t *testing.T) {
	...
	// Complete session immediately.
	ri.EXPECT().CompletePipelineSession(gomock.Any(), "sess-empty").Return(nil)
	gs.EXPECT().HeadCommit(gomock.Any(), "machine/test").Return("abc123", nil)
	ri.EXPECT().SetPipelineWatermark(gomock.Any(), "review", "machine/test", "abc123").Return(nil)
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-empty").Return(0, 0, nil)
...
func TestReflectStepNotCreatedWhenNoHypotheses(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-noh").Return(&store.PipelineSession{
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-noh").Return(&store.PipelineWorkItem{
		ID:        1,
		SessionID: "sess-noh",
		StepType:  "prune",
		FactsJSON: mustJSON(t, facts),
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-noh").Return(nil, nil)
	...
	gs.EXPECT().HeadCommit(gomock.Any(), "machine/test").Return("new-hash", nil)
	ri.EXPECT().SetPipelineWatermark(gomock.Any(), "review", "machine/test", "new-hash").Return(nil)
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-noh").Return(1, 0, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	result, err := r.ContinueSession(context.Background(), "sess-noh", pruneResp)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if !result.Done {
...
func TestReflectStepCreatedWhenHypothesesRetracted(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-hyp").Return(&store.PipelineSession{
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-hyp").Return(&store.PipelineWorkItem{
		ID:        1,
		SessionID: "sess-hyp",
		StepType:  "prune",
		FactsJSON: mustJSON(t, facts),
	...
	// nextItem: no more items → reflect check.
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-hyp").Return(nil, nil)
	...
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-hyp").Return(1, 1, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	result, err := r.ContinueSession(context.Background(), "sess-hyp", pruneResp)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if result.Done {
...
func TestReflectStepCreatedWhenHypothesisPromoted(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-prom").Return(&store.PipelineSession{
	...
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-prom").Return(&store.PipelineWorkItem{
		ID:        1,
		SessionID: "sess-prom",
		StepType:  "prune",
		FactsJSON: mustJSON(t, facts),
	...
	// nextItem: no more items → reflect check.
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-prom").Return(nil, nil)
	...
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-prom").Return(1, 1, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	result, err := r.ContinueSession(context.Background(), "sess-prom", pruneResp)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if result.Done {
...
func TestContinueSession_ReflectResponseCompletesSession(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-ref").Return(&store.PipelineSession{
		ID: "sess-ref", Branch: "machine/test", Status: "active",
	}, nil).AnyTimes()

	// Current work item is reflect.
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-ref").Return(&store.PipelineWorkItem{
		ID:         5,
		SessionID:  "sess-ref",
		StepType:   "reflect",
		ClusterKey: "reflect",
	...
	ri.EXPECT().SetPipelineWorkItemResponse(gomock.Any(), int64(5), reflectResp).Return(nil)

	// nextItem after reflect: no more items → reflect already checked → complete session.
	ri.EXPECT().NextPipelineWorkItem(gomock.Any(), "sess-ref").Return(nil, nil)
	// findHypothesisTransitions (first time for this session).
	ri.EXPECT().GetPipelineWatermark(gomock.Any(), "review", "machine/test").Return("", nil)
	// completeSession.
	ri.EXPECT().CompletePipelineSession(gomock.Any(), "sess-ref").Return(nil)
	gs.EXPECT().HeadCommit(gomock.Any(), "machine/test").Return("final-hash", nil)
	ri.EXPECT().SetPipelineWatermark(gomock.Any(), "review", "machine/test", "final-hash").Return(nil)
	ri.EXPECT().PipelineWorkItemStats(gomock.Any(), "sess-ref").Return(1, 0, nil)

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	result, err := r.ContinueSession(context.Background(), "sess-ref", reflectResp)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if !result.Done {
...
func TestFindHypothesisTransitions_ConfidenceUpdate(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-conf").Return(&store.PipelineSession{
...
func TestFindHypothesisTransitions_DiffFilesError(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-diff-err").Return(&store.PipelineSession{
		ID: "sess-diff-err", Branch: "machine/test", Status: "active",
	}, nil)
	ri.EXPECT().GetPipelineWatermark(gomock.Any(), "review", "machine/test").Return("old-hash", nil)
	gs.EXPECT().DiffFiles(gomock.Any(), "machine/test", "old-hash").Return(nil, nil, nil, fmt.Errorf("git diff failed"))

	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	_, err := r.findHypothesisTransitions(context.Background(), "sess-diff-err")
	if err == nil {
...
func TestFindHypothesisTransitions_EmptyWatermark(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-no-wm").Return(&store.PipelineSession{
	...
	r := NewReviewer(gs, idx, ri, NewMockEmbedder(ctrl), nil, "machine/test")
	transitions, err := r.findHypothesisTransitions(context.Background(), "sess-no-wm")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestFindHypothesisTransitions_ModifiedNonHypothesisSkipped(t *testing.T) {
	...
	ri.EXPECT().GetPipelineSession(gomock.Any(), "sess-nonhyp").Return(&store.PipelineSession{
