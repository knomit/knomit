...
// Source: knomit/internal/synthesize (interfaces: GitStore,SearchIndex,Embedder,PairwiseDistancer)
//
// Generated by this command:
//
//	mockgen -destination=internal/synthesize/mock_deps_test.go -package=synthesize knomit/internal/synthesize GitStore,SearchIndex,Embedder,PairwiseDistancer
//
...
// MockPairwiseDistancer is a mock of PairwiseDistancer interface.
type MockPairwiseDistancer struct {
	ctrl     *gomock.Controller
	recorder *MockPairwiseDistancerMockRecorder
	isgomock struct{}
}

// MockPairwiseDistancerMockRecorder is the mock recorder for MockPairwiseDistancer.
type MockPairwiseDistancerMockRecorder struct {
	mock *MockPairwiseDistancer
}

// NewMockPairwiseDistancer creates a new mock instance.
func NewMockPairwiseDistancer(ctrl *gomock.Controller) *MockPairwiseDistancer {
	mock := &MockPairwiseDistancer{ctrl: ctrl}
	mock.recorder = &MockPairwiseDistancerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPairwiseDistancer) EXPECT() *MockPairwiseDistancerMockRecorder {
	return m.recorder
}

// PairwiseDistances mocks base method.
func (m *MockPairwiseDistancer) PairwiseDistances(paths []string) ([]string, [][]float64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PairwiseDistances", paths)
	ret0, _ := ret[0].([]string)
...
// PairwiseDistances indicates an expected call of PairwiseDistances.
func (mr *MockPairwiseDistancerMockRecorder) PairwiseDistances(paths any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PairwiseDistances", reflect.TypeOf((*MockPairwiseDistancer)(nil).PairwiseDistances), paths)
}
