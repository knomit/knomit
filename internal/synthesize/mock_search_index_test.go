...
//
//	mockgen -destination=internal/synthesize/mock_search_index_test.go -package=synthesize knomit/internal/store SearchIndex
//
...
func (m *MockSearchIndex) Stats(ctx context.Context, branch, pathPrefix, axis string) (store.StatsResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Stats", ctx, branch, pathPrefix, axis)
...
func (mr *MockSearchIndexMockRecorder) Stats(ctx, branch, pathPrefix, axis any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Stats", reflect.TypeOf((*MockSearchIndex)(nil).Stats), ctx, branch, pathPrefix, axis)
}
