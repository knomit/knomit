...
//
// The measured worst case is 9,572 bytes (2026-09-14), against the 5,893 this
...
// from over-promising. Expect roughly 1 KiB more from the rest-bucket and
// declined-reason work, which still fits; re-measure rather than assume.
