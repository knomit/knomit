...
func TestBridgeComponentReport_CrossCommunity_Kept(t *testing.T) {
	...
	results, err := BridgeComponentReport(ctx, idx, branch, BridgeEntity, EffortHigh, 1.0, 1, cfg, PoolBackward)
...
func TestBridgeComponentReport_ErrorPropagation_SimilarityAdjacency(t *testing.T) {
	...
	_, err := BridgeComponentReport(ctx, idx, branch, BridgeEntity, EffortHigh, 1.0, 1, cfg, PoolBackward)
	require.Error(t, err)
...
func TestBridgeComponentReport_NormalEffort_Empty(t *testing.T) {
	...
	results, err := BridgeComponentReport(ctx, idx, branch, BridgeEntity, EffortNormal, 1.0, 1, cfg, PoolBackward)
	require.NoError(t, err)
