...
// Source: knomit/internal/mcp (interfaces: GitStore,SearchIndex)
//
// Generated by this command:
//
//	mockgen -destination=internal/mcp/mock_store_test.go -package=mcp knomit/internal/mcp GitStore,SearchIndex
//
