...
func TestExplainFirstPage(t *testing.T) {
	...
	sessionIdx.EXPECT().CreateToolSession(gomock.Any(), "explain", "machine/test", "kb/root.md").Return(&ToolSession{ID: "sess-1", Status: "active"}, nil)
	sessionIdx.EXPECT().AddSeenPaths(gomock.Any(), "sess-1", []string{"kb/root.md"}).Return(nil)
	sessionIdx.EXPECT().EnqueuePaths(gomock.Any(), "sess-1", []QueueItem{
		{Path: "kb/tech/ref1.md", CommitHash: "abc12345", Depth: 1},
	}).Return(nil)
	sessionIdx.EXPECT().QueueSize(gomock.Any(), "sess-1").Return(1, nil)
...
func TestExplainResumesSession(t *testing.T) {
	...
	sessionIdx.EXPECT().GetToolSession(gomock.Any(), "sess-1").Return(&ToolSession{ID: "sess-1", Status: "active"}, nil)
	sessionIdx.EXPECT().GetSeenPaths(gomock.Any(), "sess-1").Return(map[string]bool{"kb/root.md": true}, nil)
...
func TestExplainNoRefs(t *testing.T) {
	...
	sessionIdx.EXPECT().CreateToolSession(gomock.Any(), "explain", "machine/test", "kb/solo.md").Return(&ToolSession{ID: "sess-2", Status: "active"}, nil)
	sessionIdx.EXPECT().AddSeenPaths(gomock.Any(), "sess-2", []string{"kb/solo.md"}).Return(nil)
	// No EnqueuePaths call — no local refs.
	sessionIdx.EXPECT().QueueSize(gomock.Any(), "sess-2").Return(0, nil)
	sessionIdx.EXPECT().UpdateToolSession(gomock.Any(), "sess-2", "def456", "completed").Return(nil)
...
func TestExplainExpiredSession(t *testing.T) {
	...
	sessionIdx.EXPECT().GetToolSession(gomock.Any(), "expired-1").Return(nil, nil)
...
func TestExplainDeletedRef(t *testing.T) {
	...
	sessionIdx.EXPECT().GetToolSession(gomock.Any(), "sess-3").Return(&ToolSession{ID: "sess-3", Status: "active"}, nil)
	sessionIdx.EXPECT().GetSeenPaths(gomock.Any(), "sess-3").Return(map[string]bool{"kb/root.md": true}, nil)
	sessionIdx.EXPECT().DequeuePaths(gomock.Any(), "sess-3", 25).Return([]QueueItem{
	...
	sessionIdx.EXPECT().UpdateToolSession(gomock.Any(), "sess-3", "", "completed").Return(nil)
...
func TestExplainMaxDepth(t *testing.T) {
	...
	sessionIdx.EXPECT().GetToolSession(gomock.Any(), "sess-4").Return(&ToolSession{ID: "sess-4", Status: "active"}, nil)
	sessionIdx.EXPECT().GetSeenPaths(gomock.Any(), "sess-4").Return(map[string]bool{"kb/root.md": true}, nil)
	...
	sessionIdx.EXPECT().UpdateToolSession(gomock.Any(), "sess-4", "", "completed").Return(nil)
...
func TestExplainExternalRefsOnly(t *testing.T) {
	...
	sessionIdx.EXPECT().CreateToolSession(gomock.Any(), "explain", "machine/test", "kb/ext.md").Return(&ToolSession{ID: "sess-5", Status: "active"}, nil)
	sessionIdx.EXPECT().AddSeenPaths(gomock.Any(), "sess-5", []string{"kb/ext.md"}).Return(nil)
	// No EnqueuePaths — no local refs.
	sessionIdx.EXPECT().QueueSize(gomock.Any(), "sess-5").Return(0, nil)
	sessionIdx.EXPECT().UpdateToolSession(gomock.Any(), "sess-5", "ext123", "completed").Return(nil)
...
func TestExplainResumeEmptyQueue(t *testing.T) {
	...
	sessionIdx.EXPECT().GetToolSession(gomock.Any(), "sess-done").Return(&ToolSession{
		ID: "sess-done", Tool: "explain", Status: "active",
	}, nil)
	sessionIdx.EXPECT().GetSeenPaths(gomock.Any(), "sess-done").Return(map[string]bool{"kb/root.md": true}, nil)
	sessionIdx.EXPECT().DequeuePaths(gomock.Any(), "sess-done", 25).Return(nil, nil)
	sessionIdx.EXPECT().QueueSize(gomock.Any(), "sess-done").Return(0, nil)
	sessionIdx.EXPECT().UpdateToolSession(gomock.Any(), "sess-done", "", "completed").Return(nil)
...
func TestExplainRetractedRef(t *testing.T) {
	...
	sessionIdx.EXPECT().GetToolSession(gomock.Any(), "sess-ret").Return(&ToolSession{ID: "sess-ret", Status: "active"}, nil)
	sessionIdx.EXPECT().GetSeenPaths(gomock.Any(), "sess-ret").Return(map[string]bool{"kb/root.md": true}, nil)
...
func TestExplainResumeParseError(t *testing.T) {
	...
	sessionIdx.EXPECT().GetToolSession(gomock.Any(), "sess-pe").Return(&ToolSession{
	...
	sessionIdx.EXPECT().UpdateToolSession(gomock.Any(), "sess-pe", "", "completed").Return(nil)
...
func TestExplainFirstPageIncludesAllFactFields(t *testing.T) {
	...
	sessionIdx.EXPECT().CreateToolSession(gomock.Any(), "explain", "machine/test", "kb/full.md").Return(&ToolSession{ID: "sess-full", Status: "active"}, nil)
	sessionIdx.EXPECT().AddSeenPaths(gomock.Any(), "sess-full", []string{"kb/full.md"}).Return(nil)
	sessionIdx.EXPECT().QueueSize(gomock.Any(), "sess-full").Return(0, nil)
	sessionIdx.EXPECT().UpdateToolSession(gomock.Any(), "sess-full", "deadbeef", "completed").Return(nil)
...
func TestExplainResumeIncludesAllFactFields(t *testing.T) {
	...
	sessionIdx.EXPECT().GetToolSession(gomock.Any(), "sess-r").Return(&ToolSession{ID: "sess-r", Status: "active"}, nil)
	sessionIdx.EXPECT().GetSeenPaths(gomock.Any(), "sess-r").Return(map[string]bool{}, nil)
	...
	sessionIdx.EXPECT().UpdateToolSession(gomock.Any(), "sess-r", "", "completed").Return(nil)
