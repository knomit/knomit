...
// tray's lockfile, logs, and autostart artifacts.
package paths

import "path/filepath"

// StateDir returns the directory where the tray persists state
// (lockfile, etc.). The directory is NOT created by this function.
func StateDir() (string, error) { return stateDir() }

// LogsDir returns the directory where the tray writes log files.
