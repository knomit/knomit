...
The directory tree under `general/` forms an ontological hierarchy. Facts placed at higher levels apply to everything below them — a fact at `general/geography/` is inherited by `general/geography/europe/uk/london/`.
...
|------|---------|---------|
| Relative (no authority) | Current knowledge base | `knomit:/general/technology/debugging/pool-fix.md` |
